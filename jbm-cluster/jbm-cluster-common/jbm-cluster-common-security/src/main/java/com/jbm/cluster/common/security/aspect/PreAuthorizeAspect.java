...
public class PreAuthorizeAspect {
     ...
     */
    public static final String POINTCUT_SIGN = " @annotation(com.jbm.cluster.common.security.annotation.RequiresLogin) || "
            + "@annotation(com.jbm.cluster.common.security.annotation.RequiresPermissions) || "
            + "@annotation(com.jbm.cluster.common.security.annotation.RequiresRoles)";
