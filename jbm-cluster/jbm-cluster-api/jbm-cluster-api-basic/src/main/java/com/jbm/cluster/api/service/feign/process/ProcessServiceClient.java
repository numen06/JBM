...
public interface ProcessServiceClient {
    ...
    DataPaging<RuleInstanceModel> pageQueryProcessInstances(
    ...
    RuleInstanceModel getProcessInstanceById(
            @RequestBody(required = false) ProcessInstancePageForm pageForm);
     ...
     */
    @PostMapping("/execute")
    ExecuteProcessResponse executeProcess(@RequestBody ExecuteProcessRequest request);
    
    /**
     * 根据json创建流程实例
     */
    @PostMapping("/createProcessByJson")
    ProcessInstance createProcessByJson(
    ...
    ExecuteProcessResponse executeProcessByJson(
            @RequestBody ExecuteProcessByJsonRequest request);
    ...
    ExecuteProcessResponse continueProcess(@RequestBody ExecuteProcessRequest request);
    
    /**
     * 解析流程json
     */
    @PostMapping("/parseProcessByJson")
    FlowData parseProcessByJson(
            @RequestBody ExecuteProcessByJsonRequest request);
}
