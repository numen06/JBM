...
import com.jbm.cluster.common.mysql.service.BaseReleaseInfoService;
...
public class BaseReleaseInfoController extends BaseController {

    @Autowired
    private BaseReleaseInfoService baseReleaseInfoService;
    ...
    public ResultBody<BaseReleaseInfo> findLastVersionInfo(@RequestBody(required = false) BaseReleaseInfo releaseInfo) {
        try {
            BaseReleaseInfo reslut = baseReleaseInfoService.findLastVersionInfo(releaseInfo);
