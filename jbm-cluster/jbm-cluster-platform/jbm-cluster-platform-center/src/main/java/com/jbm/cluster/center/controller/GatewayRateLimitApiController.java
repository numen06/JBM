...
public class GatewayRateLimitApiController extends MasterDataCollection<GatewayRateLimitApi, GatewayRateLimitApiService> {
    ...
    @Override
    public ResultBody<DataPaging<GatewayRateLimitApi>> pageList(@RequestBody(required = false) PageRequestBody pageRequestBody) {
    ...
    @PostMapping("/list")
    @Override
    public ResultBody<List<GatewayRateLimitApi>> list(@RequestBody(required = false) MasterDataRequsetBody masterDataRequsetBody) {
    ...
    @PostMapping("/model")
    @Override
    public ResultBody<GatewayRateLimitApi> model(@RequestBody(required = false) MasterDataRequsetBody masterDataRequsetBody) {
    ...
    @PostMapping("/save")
    @Override
    public ResultBody<GatewayRateLimitApi> save(@RequestBody(required = false) MasterDataRequsetBody masterDataRequsetBody) {
    ...
    @Override
    public ResultBody<List<GatewayRateLimitApi>> saveBatch(@RequestBody(required = false) MasterDataRequsetBody masterDataRequsetBody) {
    ...
    @PostMapping("/mock")
    @Override
    public ResultBody<GatewayRateLimitApi> mock() {
        return super.mock();
    }
