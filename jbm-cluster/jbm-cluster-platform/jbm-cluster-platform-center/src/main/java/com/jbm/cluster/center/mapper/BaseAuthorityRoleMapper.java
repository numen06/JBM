...
public interface BaseAuthorityRoleMapper extends SuperMapper<BaseAuthorityRole> {
     ...
     * @return
     */
    List<OpenAuthority> selectAuthorityByRole(@Param("roleId") Long roleId, @Param("appId") Long appId);
     ...
     * @return
     */
    List<AuthorityMenu> selectAuthorityMenuByRole(@Param("roleId") Long roleId, @Param("appId") Long appId);
}
