...
public class BaseActionController extends MasterDataCollection<BaseAction, BaseActionService> {
    ...
    @Override
    public ResultBody<DataPaging<BaseAction>> pageList(@RequestBody(required = false) PageRequestBody pageRequestBody) {
    ...
    @PostMapping("/list")
    @Override
    public ResultBody<List<BaseAction>> list(@RequestBody(required = false) MasterDataRequsetBody masterDataRequsetBody) {
    ...
    @PostMapping("/model")
    @Override
    public ResultBody<BaseAction> model(@RequestBody(required = false) MasterDataRequsetBody masterDataRequsetBody) {
    ...
    @PostMapping("/save")
    @Override
    public ResultBody<BaseAction> save(@RequestBody(required = false) MasterDataRequsetBody masterDataRequsetBody) {
    ...
    @Override
    public ResultBody<List<BaseAction>> saveBatch(@RequestBody(required = false) MasterDataRequsetBody masterDataRequsetBody) {
    ...
    @PostMapping("/mock")
    @Override
    public ResultBody<BaseAction> mock() {
        return super.mock();
    }
