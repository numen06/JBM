...
public class GatewayIpLimitApiController extends MasterDataCollection<GatewayIpLimitApi, GatewayIpLimitApiService> {
    ...
    @Override
    public ResultBody<DataPaging<GatewayIpLimitApi>> pageList(@RequestBody(required = false) PageRequestBody pageRequestBody) {
    ...
    @PostMapping("/list")
    @Override
    public ResultBody<List<GatewayIpLimitApi>> list(@RequestBody(required = false) MasterDataRequsetBody masterDataRequsetBody) {
    ...
    @PostMapping("/model")
    @Override
    public ResultBody<GatewayIpLimitApi> model(@RequestBody(required = false) MasterDataRequsetBody masterDataRequsetBody) {
    ...
    @PostMapping("/save")
    @Override
    public ResultBody<GatewayIpLimitApi> save(@RequestBody(required = false) MasterDataRequsetBody masterDataRequsetBody) {
    ...
    @Override
    public ResultBody<List<GatewayIpLimitApi>> saveBatch(@RequestBody(required = false) MasterDataRequsetBody masterDataRequsetBody) {
    ...
    @PostMapping("/mock")
    @Override
    public ResultBody<GatewayIpLimitApi> mock() {
        return super.mock();
    }
