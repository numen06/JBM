...
public class BaseAuthorityUserController extends MasterDataCollection<BaseAuthorityUser, BaseAuthorityUserService> {
    ...
    @Override
    public ResultBody<DataPaging<BaseAuthorityUser>> pageList(@RequestBody(required = false) PageRequestBody pageRequestBody) {
    ...
    @PostMapping("/list")
    @Override
    public ResultBody<List<BaseAuthorityUser>> list(@RequestBody(required = false) MasterDataRequsetBody masterDataRequsetBody) {
    ...
    @PostMapping("/model")
    @Override
    public ResultBody<BaseAuthorityUser> model(@RequestBody(required = false) MasterDataRequsetBody masterDataRequsetBody) {
    ...
    @PostMapping("/save")
    @Override
    public ResultBody<BaseAuthorityUser> save(@RequestBody(required = false) MasterDataRequsetBody masterDataRequsetBody) {
    ...
    @Override
    public ResultBody<List<BaseAuthorityUser>> saveBatch(@RequestBody(required = false) MasterDataRequsetBody masterDataRequsetBody) {
    ...
    @PostMapping("/mock")
    @Override
    public ResultBody<BaseAuthorityUser> mock() {
        return super.mock();
    }
