...
public class BaseAuthorityActionController extends MasterDataCollection<BaseAuthorityAction, BaseAuthorityActionService> {
    ...
    @Override
    public ResultBody<DataPaging<BaseAuthorityAction>> pageList(@RequestBody(required = false) PageRequestBody pageRequestBody) {
    ...
    @PostMapping("/list")
    @Override
    public ResultBody<List<BaseAuthorityAction>> list(@RequestBody(required = false) MasterDataRequsetBody masterDataRequsetBody) {
    ...
    @PostMapping("/model")
    @Override
    public ResultBody<BaseAuthorityAction> model(@RequestBody(required = false) MasterDataRequsetBody masterDataRequsetBody) {
    ...
    @PostMapping("/save")
    @Override
    public ResultBody<BaseAuthorityAction> save(@RequestBody(required = false) MasterDataRequsetBody masterDataRequsetBody) {
    ...
    @Override
    public ResultBody<List<BaseAuthorityAction>> saveBatch(@RequestBody(required = false) MasterDataRequsetBody masterDataRequsetBody) {
    ...
    @PostMapping("/mock")
    @Override
    public ResultBody<BaseAuthorityAction> mock() {
        return super.mock();
    }
