...
//    @PostConstruct
//    public void init() throws WxErrorException, MalformedURLException {
//        WxMpMenu mpMenu = this.wxService.getMenuService().menuGet();
//        System.out.println(mpMenu.toJson());
//        if (mpMenu == null) {
//            menuCreateSample(wxService.getWxMpConfigStorage().getAppId());
//        }
//    }
