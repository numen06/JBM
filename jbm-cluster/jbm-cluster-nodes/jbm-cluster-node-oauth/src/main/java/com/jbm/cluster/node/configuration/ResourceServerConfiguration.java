...
import com.jbm.cluster.node.configuration.security.ApiWebSecurityConfiguration;
...
public class ResourceServerConfiguration extends ResourceServerConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        String[] whiteList = ArrayUtil.append(jbmClusterProperties.getPermitAll(), ApiWebSecurityConfiguration.AUTH_WHITELIST);
