...
public class ClassPathFile {
	...
	/**
	 * Create a new {@code ClassPathFile} for {@code ClassLoader} usage. A
	 ...
	 */
	public ClassPathFile(String path, ClassLoader classLoader) {
	...
	/**
	 * Create a new {@code ClassPathFile} for {@code Class} usage. The path can
	 ...
	 */
	public ClassPathFile(String path, Class<?> clazz) {
		Assert.notNull(path, "Path must not be null");
	...
	/**
	 * Create a new {@code ClassPathFile} with optional {@code ClassLoader} and
	 ...
	 */
	protected ClassPathFile(String path, ClassLoader classLoader, Class<?> clazz) {
		this.path = PathUtils.cleanPath(path);
	...
	/**
	 * This implementation creates a ClassPathFile, applying the given path
	 * relative to the path of the underlying resource of this descriptor.
	 * 
	 * @see org.springframework.util.PathUtils#applyRelativePath(String, String)
	 */
	public ClassPathFile createRelative(String relativePath) {
		String pathToUse = PathUtils.applyRelativePath(this.path, relativePath);
		return new ClassPathFile(pathToUse, this.classLoader, this.clazz);
	}
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof ClassPathFile) {
			ClassPathFile otherRes = (ClassPathFile) obj;
	...
	public static void main(String[] args) throws IOException {
		ClassPathFile file = new ClassPathFile("test.txt");
