...
import com.td.util.ConvertUtils;
import com.td.util.TimeUtil;

import td.framework.excel.handler.ExcelHeader;
import td.framework.excel.handler.ExcelResource;
...
public class ExcelTemplate {
	...
	private void createCell(Workbook workbook, Row row, Integer j, ExcelHeader h, Object value) {
		...
		if (h.getFiledClazz().equals(Date.class)) {
			cell.setCellValue(TimeUtil.format((Date) value, h.getFormat()));
		} else {
