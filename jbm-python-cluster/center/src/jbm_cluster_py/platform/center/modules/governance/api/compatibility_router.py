...
GET /operator-application/current
...
GET /role/all
GET /tenant-delegation
GET /tenant-delegation/received
GET /tenant-delegation/{id}
GET /user
GET /user/{userId}
...
POST /baseUserConfig/model
POST /baseUserCertification/updateFaceImage
POST /user/getUserInfoStatistics
POST /user/list
POST /user/model
POST /user/pageList
...
POST /operator-application/current
POST /role
POST /tenant-delegation
POST /user
POST /user/model
POST /user/userRoles
...
PUT /menu/{menuId}
PUT /operator-application/{id}/review
PUT /role/{roleId}
PUT /role/{roleId}/users
PUT /tenant-delegation/{id}
PUT /user/{userId}
