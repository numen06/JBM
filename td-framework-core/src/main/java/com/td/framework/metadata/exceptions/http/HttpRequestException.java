...
import com.td.framework.metadata.usage.bean.http.IRateLimiting;
import com.td.framework.metadata.usage.bean.http.ResponseWrapper;
import com.td.framework.metadata.usage.bean.http.ResponseWrapper.ErrorObject;

public class HttpRequestException extends Exception implements IRateLimiting {
	...
	public HttpRequestException(ResponseWrapper responseWrapper) {
