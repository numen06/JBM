...
| [专用测试用户](modules/test-user-test-report.md) | 2 | 0 | FAIL |
| [OAuth2 core](modules/oauth2-core-test-report.md) | 5 | 1 | FAIL |
| [Sa-Token OAuth2 align](modules/satoken-align-test-report.md) | 4 | 1 | FAIL |
| [login lock](modules/oauth2-lock-test-report.md) | 11 | 0 | FAIL |
