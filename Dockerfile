FROM registry.cn-shanghai.aliyuncs.com/51jbm/spring-boot-layer:dragonwell8_452 as builder
ARG JAR_FILE=*.jar
COPY ${JAR_FILE} application.jar
RUN java -Djarmode=layertools -jar application.jar extract

FROM registry.cn-shanghai.aliyuncs.com/51jbm/spring-boot-layer:dragonwell8_452
