        ...
        [
            ...
            function($stateProvider, $urlRouterProvider) {
                ...
                $stateProvider
                    ...
                    .state('app.programUpload', {
                        url: '/program/upload',
                        templateUrl: 'views/program/upload.html',
                        ncyBreadcrumb: {
                            label: '在线发布'
                        },
                        resolve: {
                            deps: [
                                '$ocLazyLoad',
                                function($ocLazyLoad) {
                                    return $ocLazyLoad.load(['ngTagsInput','toaster','dropzone','pagination']).then(
                                        function() {
                                            return $ocLazyLoad.load(
                                            {
                                                serie: true,
                                                files: [
                                                    'app/controllers/biz/program.js',
                                                ]
                                            });
                                        }
                                    );
                    ...
                    .state('app.sourceList', {
                        url: '/program/sourceList',
                        templateUrl: 'views/program/sourceList.html',
                        ncyBreadcrumb: {
                            label: '源码管理'
                        },
                        resolve: {
                                        ...
                                        function() {
                                            return $ocLazyLoad.load(
                                            {
                                                ...
                                                files: [
                                                    ...
                                                    'app/controllers/biz/sourceList.js',
                                                    'assets/plugins/ztree/jquery.ztree.core-3.5.js',
                                                    'assets/plugins/ztree/zTreeStyle.css',
                                                    'assets/plugins/ztree/jquery.ztree.excheck.js',
                                                    'assets/plugins/ztree/jquery.ztree.exedit-3.5.min.js',
                                                ]
                                            });
                                        }
                                    );
                    ...
                    .state('app.programList', {
                        url: '/program/programList',
                        templateUrl: 'views/program/programList.html',
                        ncyBreadcrumb: {
                            label: '进程管理'
                        },
                        resolve: {
                                    ...
                                    return $ocLazyLoad.load(['ngTagsInput','toaster','dropzone','pagination']).then(
                                        function() {
                                            return $ocLazyLoad.load(
                                            {
                                                ...
                                                files: [
                                                    'assets/plugins/bootbox/bootbox.js',
                                                    'app/controllers/biz/programList.js',
                                                    'assets/plugins/ztree/jquery.ztree.core-3.5.js',
                                                    'assets/plugins/ztree/zTreeStyle.css',
                                                    'assets/plugins/ztree/jquery.ztree.excheck.js',
                                                    'assets/plugins/ztree/jquery.ztree.exedit-3.5.min.js',
                    ...
                    .state('app.recoveryList', {
                        url: '/program/recoveryList',
                        templateUrl: 'views/program/recoveryList.html',
                        ncyBreadcrumb: {
                            label: '回收站管理'
                        },
                        resolve: {
                            deps: [
                                '$ocLazyLoad',
                                function($ocLazyLoad) {
                                    return $ocLazyLoad.load(['ngTagsInput','toaster','pagination']).then(
                                        function() {
                                            return $ocLazyLoad.load(
                                            {
                                                serie: true,
                                                files: [
                                                    'assets/plugins/bootbox/bootbox.js',
                                                    'app/controllers/biz/recoveryList.js',
                                                ]
                                            });
                                        }
                                    );
