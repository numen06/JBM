...
public class LevelMappingContext<E extends KeyValuePersistentEntity<?, P>, P extends KeyValuePersistentProperty<P>>
    ...
    public LevelMappingContext(MappingConfiguration mappingConfiguration) {
        ...
        this.timeToLiveAccessor = new ConfigAwareTimeToLiveAccessor(
    ...
    static class ConfigAwareTimeToLiveAccessor implements org.springframework.data.level.core.TimeToLiveAccessor {
        ...
        public Long getTimeToLive(final Object source) {
            ...
            if (ttlProperty != null) {
                ...
                LevelPersistentEntity entity = (LevelPersistentEntity) mappingContext.getPersistentEntity(type);
        ...
        private Long resolveDefaultTimeOut(Class<?> type) {
            ...
            LevelHash hash = (LevelHash) mappingContext.getPersistentEntity(type).findAnnotation(LevelHash.class);
