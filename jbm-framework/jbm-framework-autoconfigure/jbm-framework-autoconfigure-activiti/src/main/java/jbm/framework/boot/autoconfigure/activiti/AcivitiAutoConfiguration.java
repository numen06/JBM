package jbm.framework.boot.autoconfigure.activiti;
...
@AutoConfigureAfter(name = { "org.springframework.boot.autoconfigure.jdbc.DataSourceAutoConfiguration", "jbm.framework.boot.autoconfigure.mybatis.MybatisAutoConfiguration" })
