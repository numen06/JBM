...
public class JsonClientStarter {
    ...
    private static void send() {
        try {
            ...
            packet.pack(FileUtil.readBytes("D:/maven_workspaces/jbm-framework/jbm-framework-autoconfigure/jbm-framework-autoconfigure-tio/src/test/resources/jbm-tdccp.log"));
