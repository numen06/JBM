...
public interface IMqttClientFactory {
    ...
    default KeyManagerFactory getKeyManagerFactory(final HiveMqttProperties.SslProperties certProperties) throws KeyManagerFactoryCreationException {
        try {
...
//            final PrivateKey key = PrivateKeyReader.getPrivateKey(certProperties.getPrivateKey(), certProperties.getPassword());
    ...
    default TrustManagerFactory getTrustManagerFactory(final HiveMqttProperties.SslProperties certProperties) throws TrustManagerFactoryCreationException {
        try {
