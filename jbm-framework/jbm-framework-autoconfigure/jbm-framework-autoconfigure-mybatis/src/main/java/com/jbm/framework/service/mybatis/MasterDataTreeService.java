...
public class MasterDataTreeService<Entity extends MasterDataTreeEntity> extends MasterDataServiceImpl<Entity>
	...
	@Override
	public List<Entity> selectListByParentId(String parentCode) throws DataServiceException {
		return this.selectEntitys(MapUtils.newParamMap("parentId", parentCode));
	}
