...
public class BeetlSqlEngine implements TemplateEngine {
     ...
     * @param config 模板配置
     */
    public BeetlSqlEngine(TemplateConfig config) {
        init(config);
    }
     ...
     */
    public BeetlSqlEngine(GroupTemplate engine) {
        init(engine);
    }
    // --------------------------------------------------------------------------------- Constructor end
