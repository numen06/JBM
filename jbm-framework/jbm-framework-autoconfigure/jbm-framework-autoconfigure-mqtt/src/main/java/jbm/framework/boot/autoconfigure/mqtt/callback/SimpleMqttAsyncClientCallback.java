...
public class SimpleMqttAsyncClientCallback implements MqttCallbackExtended {
    ...
    protected final IMqttAsyncClient mqttClient;
    ...
    public void connectComplete(boolean b, String s) {
        log.info("MQTT Async Client[{}]连接成功", mqttClient.getClientId());
    }


    @Override
    public void connectionLost(Throwable throwable) {
        log.warn("MQTT Async Client[{}]连接丢失", mqttClient.getClientId(), throwable);
