...
public class ResultForm implements Serializable {
	...
	public static Object error(Object result, String message, Exception e) {
		return error(result, 500, message, e);
	}

	public static Object error(Object result, Integer errorCode, String message, Exception e) {
