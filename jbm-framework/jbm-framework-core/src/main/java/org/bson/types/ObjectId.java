...
public class ObjectId implements Comparable<ObjectId>, java.io.Serializable {
     ...
     * driver has done it this way for a long time, but it does not match the
     ...
     * <a href=
     * "http://docs.mongodb.org/manual/reference/object-id/">ObjectId
     * specification</a>. Please use
     ...
     *
     * @param s      the string representation of ObjectId. Can contains only
